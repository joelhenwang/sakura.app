...
List<Widget> _buildPages(){
  return[
    ...
    Container(
      child: Image.asset('assets/bebidas/tinto_rose.jpg'),
    ),
    Container(
      child: Image.asset('assets/bebidas/aperitivos_whisky.jpg'),
    ),
    Container(
      child: Image.asset('assets/bebidas/sekerinha_gin.jpg'),
    ),
  ];
}
